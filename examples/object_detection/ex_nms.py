...
from indigits.vision import object_detection as od
...
image1 = iv.blank_image(400, 400)
image2 = image1.copy()
dm = iv.DisplayManager(['all boxes', 'after suppression'], gap_x=400)
for bbox in bounding_boxes:
    x_0, y_0, x_1, y_1 = bbox
    cv2.rectangle(image1, (x_0, y_0), (x_1, y_1), iv.RED, 2)
dm.show(image1, 0)
...
for bbox in final_bb:
    x_0, y_0, x_1, y_1 = bbox
    cv2.rectangle(image2, (x_0, y_0), (x_1, y_1), iv.RED, 2)
dm.show(image2, 1)
cv2.waitKey(0)
